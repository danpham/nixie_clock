...
void test_rotary_encoder(void) {
    ...
    rotary_encoder_test_t tests[] = {
        ...
        /* Increments */
        {0, 0, 1, 0, ROTARY_ENCODER_EVENT_INCREMENT},
        {0, 1, 0, 0, ROTARY_ENCODER_EVENT_INCREMENT},
        {1, 0, 1, 1, ROTARY_ENCODER_EVENT_INCREMENT},
        {1, 1, 0, 1, ROTARY_ENCODER_EVENT_INCREMENT},
        /* Decrements */
        {0, 0, 0, 1, ROTARY_ENCODER_EVENT_DECREMENT},
        {0, 1, 1, 1, ROTARY_ENCODER_EVENT_DECREMENT},
        {1, 0, 0, 0, ROTARY_ENCODER_EVENT_DECREMENT},
        {1, 1, 1, 0, ROTARY_ENCODER_EVENT_DECREMENT},
        /* Bad states: no move */
